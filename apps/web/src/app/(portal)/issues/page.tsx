...
const STATUSES = ["NEW", "NEEDS_MANUAL_ASSIGNMENT", "ASSIGNED", "ACKNOWLEDGED", "IN_PROGRESS", "WAITING_FOR_MATERIAL", "WAITING_FOR_PARTS", "WAITING_FOR_APPROVAL", "WAITING_FOR_VENDOR", "ON_HOLD", "OVERDUE", "RESOLVED", "VERIFICATION_PENDING", "VERIFIED", "CLOSED", "REOPENED", "REJECTED", "CANCELLED"];
