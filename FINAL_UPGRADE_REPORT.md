...
- Updated the development seed so college code `6201` belongs to AVS Engineering
  College and configured its Main Admin from protected environment values.
...
- Database query confirmed AVS Engineering College, code `6201`, the configured
  Main Admin, and `must_change_password = true`.
